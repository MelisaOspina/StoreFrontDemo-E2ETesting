...
exports.config = {
    ...
    services: ['appium'],
    appium: {
        command: 'appium', // Path to your Appium binary
    },
    before: async function () {
        console.log('Starting WebDriver session...');
    },
    after: async function () {
        console.log('WebDriver session finished.');
    },
    // Patterns to exclude.
    exclude: [
    ...
    onPrepare: function () {
        console.log('Preparing for test execution...');
    },
    onComplete: function () {
    ...
    afterTest: async function (test) {
        if (test.error) {
            ...
            const fileName = `./reports/mochawesome/screenshots/${test.title}.png`;
